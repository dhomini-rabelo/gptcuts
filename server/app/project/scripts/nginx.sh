...
FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS="SHORTCUTS"
...
sudo cp "/home/ubuntu/$PROJECT_MAIN_DIR_NAME/server/app/project/nginx/nginx.conf" "/etc/nginx/sites-available/$FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS"
